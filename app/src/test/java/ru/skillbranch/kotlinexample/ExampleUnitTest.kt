...
import ru.skillbranch.kotlinexample.extentions.UserHolder
...
class ExampleUnitTest {
    ...
    */
    ...
    fun checkPhone(){
        val holder = UserHolder
        holder.checkPhone("+7 (917) 971-11-11")
        holder.checkPhone("+7 (917) 971-11-12")
//        holder.checkPhone("+a7 (917) 971-11-11")
//        holder.checkPhone("7 (917) 971-11-11")
    }
...
//        println("expectedInfo: ${successResult}")
        Assert.assertEquals(expectedInfo, successResult)
    }
